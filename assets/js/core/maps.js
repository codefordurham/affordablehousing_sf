...
function HubMap(options) {
  ...
  /* default overlays */
  this.overlays = ['/data-browser/data/geolayers/sup_districts.json', '/data-browser/data/geolayers/neighborhoods.json'];
  this.overlayData = [];
  ...
  if(options.type == 'map-point') {
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        $.getJSON('/data-browser/data/geolayers/sf_census_tracts.json', function(geodata) {
